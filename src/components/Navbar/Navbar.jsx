...
const Navbar = () => {
  ...
  useEffect(() => {
    const fetchCategorias = async () => {
      try {
        const response = await axios.get("https://wm-one.vercel.app/products/api/categories/");
  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        const response = await axios.get("https://wm-one.vercel.app/products/api/products/");
